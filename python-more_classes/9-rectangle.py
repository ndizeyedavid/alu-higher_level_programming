#!/usr/bin/python3
"""Module defining a Rectangle class with square class method."""


class Rectangle:
    """Represents a rectangle with a class method square()."""
    ...
    def __del__(self):
        """Decrement instance count and print goodbye message."""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rect_1: Must be a Rectangle instance.
            rect_2: Must be a Rectangle instance.
